            ...
            >
                ...
                >
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <Box sx={{ display: "flex", gap: "10px" }}>
                            <Box sx={{ flex: 1 }}>
                                <Typography sx={{ textAlign: "left", color: "#fff", marginTop: "10px" }}>ID</Typography>
                                <TextField
                                    fullWidth
                                    id="user-id"
                        ...
                        <FormControl fullWidth sx={{ marginTop: "20px", textAlign: "left" }} required>
                            ...
                            >
                                <MenuItem value="" disabled>Select your section</MenuItem>
                        ...
                        <FormControl fullWidth sx={{ marginTop: "20px", textAlign: "left" }} required>
                            ...
                            <Select
                                ...
                                sx={{ backgroundColor: "#3e2723", color: "#fff", borderRadius: "5px" }}
                            >
                                <MenuItem value="" disabled>Select your subject</MenuItem>
                                <MenuItem value="feedback-control">FEEDBACK CONTROL</MenuItem>
                                <MenuItem value="intro-to-algorithms">INTRODUCTION TO ALGORITHMS</MenuItem>
                                <MenuItem value="advanced-programming">ADVANCED COMPUTER PROGRAMMING FOR RAI</MenuItem>
                            </Select>
                        </FormControl>
